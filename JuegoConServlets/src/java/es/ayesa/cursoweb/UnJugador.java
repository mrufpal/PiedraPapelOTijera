...
public class UnJugador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Partida p = new Partida(jugadorA, jugadaA, "HAL9000", jugadaB);
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<p>" + jugadorA + " ha usado " + jugadaA + "</p>");
            out.println("<p>" + p.getJugadorB() + " ha usado " + jugadaB + "</p>");
            out.println("<h1>" + p.resultado() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
